...
use datafusion_comet_spark_expr::scalar_funcs::{
    ...
    spark_st_envelope, spark_st_point, spark_st_linestring, spark_st_intersects, spark_st_intersects_use_geos, spark_st_intersects_use_geo, spark_st_geomfromwkt
};
